        ...
        <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
            ...
            <form method="post">
                <div class="mb-4">
                    ...
                    <input type="text" id="title" name="title" placeholder="Enter job title" value="<?= $title ?>" class="w-full px-4 py-2 border rounded focus:ring focus:ring-blue-300 focus:outline-none">
                </div>
                <div class="mb-6">
